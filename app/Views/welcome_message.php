...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url()?>frontend/assets/images/icon.png" type="image/png">
  ...
  <link rel="stylesheet" href="<?= base_url()?>frontend/assets/css/media_query.css">
    ...
    <header class="">
      <div class="navbar">
        ...
        <a href="#" class="navbar-brand">
          <img src="<?= base_url()?>frontend//assets/images/logo.png" alt="">
        </a>
    ...
    <main>
      ...
      <section class="banner">
        <div class="banner-card">
          ...
          <img src="<?= base_url()?>frontend//assets/images/John-Wick-3.jpg" class="banner-img" alt="">
      ...
      <section class="movies">
        ...
        <div class="movies-grid">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/red-notice.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/spider-men.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/matrix.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/eternals.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/dune.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/1917.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/shang-chi.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/casino-royale.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/dark-knight.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/panther.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/venom.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/LOTR.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/saving-private-ryan.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/interstaller.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/gladiator.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/endgame.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/ww84.jpg" alt="" class="card-img">
          ...
          <div class="movie-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/movies/captain-marvel.jpg" alt="" class="card-img">
      ...
      <section class="category" id="category">
        ...
        <div class="category-grid">
          ...
          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/action.jpg" alt="" class="card-img">
            <div class="name">Action</div>
            <div class="total">100</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/comedy.jpg" alt="" class="card-img">
            <div class="name">Comedy</div>
            <div class="total">50</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/thriller.webp" alt="" class="card-img">
            <div class="name">Thriller</div>
            <div class="total">20</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/horror.jpg" alt="" class="card-img">
            <div class="name">Horror</div>
            <div class="total">80</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/adventure.jpg" alt="" class="card-img">
            <div class="name">Adventure</div>
            <div class="total">100</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/animated.jpg" alt="" class="card-img">
            <div class="name">Animated</div>
            <div class="total">50</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/crime.jpg" alt="" class="card-img">
            <div class="name">Crime</div>
            <div class="total">20</div>
          </div>

          <div class="category-card">
            <img src="<?= base_url()?>frontend//assets/images/sci-fi.jpg" alt="" class="card-img">
      ...
      <section class="live" id="live">
        ...
        <div class="live-grid">
          ...
          <div class="live-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/planet.jpg" alt="" class="card-img">
            ...
            <div class="card-body">
              <img src="<?= base_url()?>frontend//assets/images/bbcamerica.jpg" alt="" class="avatar">
          ...
          <div class="live-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/got.jpg" alt="" class="card-img">
              <div class="live-badge">LIVE</div>
            ...
            <div class="card-body">
              <img src="<?= base_url()?>frontend//assets/images/HBO-Logo-square.jpg" alt="" class="avatar">
          ...
          <div class="live-card">
            ...
            <div class="card-head">
              <img src="<?= base_url()?>frontend//assets/images/vikins.jpg" alt="" class="card-img">
              <div class="live-badge">LIVE</div>
    ...
    <footer>
      ...
      <div class="footer-content">
        ...
        <div class="footer-brand">
          <img src="<?= base_url()?>frontend//assets/images/logo.png" alt="" class="footer-logo">
